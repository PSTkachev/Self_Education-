...
"""
Задача B: 
Рулет Ваня принес на кухню рулет, который он хочет разделить с коллегами. Для этого он хочет разрезать рулет на N  равных частей. 
...
Дано одно натуральное число N (1≤N≤2⋅109) — количество людей на кофе-брейке.
