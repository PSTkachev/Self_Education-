...
class Coords:
#размещение спрайтов на экране
    def __init__(self, x1=0, y1=0, x2=0, y2=0):
        self.x1 = x1
        self.y1 = y1
        self.x2 = x2
        self.y2 = y2
#проверка пересечений одной пары х координат, с другой парой х координат
def within_x(co1, co2):
    if (co1.x1 > co2.x1 and co1.x1 < co2.x2) \
        ...
        return False
# проверка пересечений одной пары у координат, с другой парой у координат
        ...
        for sprite in self.game.sprites:
            ...
            if left and self.x < 0 and collided_left(co, sprite_co):
                ...
                if sprite.endgame:
                    ...
                    self.game.canvas.create_text(250, 30, text='ВОТ ЭТО ДА, ПОБЕДА', justify=CENTER, font=('Verdana', 14), fill='red')
